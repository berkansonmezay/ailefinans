  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Varlık ve Hesaplar</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            const itemTitle = item.name || 'İsimsiz Hesap';
            const itemSubtitle = item.type || 'Banka';
            const itemAmount = item.balance || item.amount || 0;
          ...
          ListEmptyComponent={
            <Text style={styles.emptyText}>Henüz bir hesap bulunmuyor.</Text>
          }
        />
      )}
    </SafeAreaView>
