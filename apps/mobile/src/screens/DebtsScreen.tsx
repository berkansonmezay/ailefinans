...
import { View, Text, StyleSheet, TouchableOpacity, FlatList, ActivityIndicator, Alert, TextInput, Modal, ScrollView, Dimensions, Platform, StatusBar } from 'react-native';
