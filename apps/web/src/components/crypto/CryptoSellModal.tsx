...
export function CryptoSellModal({ isOpen, onClose, onSuccess, symbol, maxQuantity }: CryptoSellModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Kripto satışı başarıyla kaydedildi.');
      onSuccess();
      onClose();
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={`${symbol} Satışı`}>
